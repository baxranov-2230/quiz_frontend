...
import { CreateGroupApi } from "../../Api/GroupApi.jsx";
...
function CreateGroup() {
  ...
  const groupMutation = useMutation({
    ...
    onSuccess: (data) => {
      toast.success(data.message || "Group muvaffaqiyatli yaratildi");
    },
    onError: (error) => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-gray-800">Group qo'shish</h2>
